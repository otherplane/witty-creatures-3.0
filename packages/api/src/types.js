...
exports.LeaderboardParams =
  exports.PlayerLeaderboardInfo =
  exports.ShareSocialsResult =
  exports.ShareSocialsParams =
  exports.InteractionResult =
  exports.InteractionParams =
  exports.GetByNumericKeyParams =
  exports.EggMetadata =
  exports.MintOutput =
  exports.MintParams =
  exports.ExtendedPlayerVTO =
  exports.ProtectedPlayerVTO =
  exports.DbInteractionVTO =
  exports.ExtendedIncubation =
  exports.Incubation =
  exports.IncubateParams =
  exports.EggProtected =
  exports.JwtVerifyPayload =
  exports.GetByStringKeyParams =
  exports.AuthorizationHeader =
  exports.IndexedEgg =
  exports.PlayerImagesReponse =
  exports.Award =
  exports.Network =
  exports.ColorTrait =
  exports.BackgroundTrait =
  exports.ObjectTrait =
  exports.OutfitTrait =
  exports.HeadTrait =
  exports.EyesTrait =
  exports.MouthTrait =
  exports.PreviewReply =
  exports.PreviewParams =
  exports.PreviewImageNameReply =
  exports.PlayerAward =
  exports.DbPlayerVTO =
  exports.PlayerVTO =
  exports.ContactIndex =
  exports.ConfigResult =
  exports.ConfigParams =
  exports.SocialResult =
  exports.SocialParams =
  exports.Social =
  exports.DbSocialVTO =
  exports.ExtendedSocial =
  exports.ClaimPlayerParams =
  exports.Nullable =
  exports.ObjectId =
  exports.Collection =
  exports.Db =
    void 0
exports.ContactListResponse =
  exports.ContactListParams =
  exports.InteractionHistoryResponse =
  exports.InteractionHistoryParams =
...
exports.SocialResult = (0, exports.Nullable)(
  typebox_1.Type.Object({
    ownerKey: typebox_1.Type.String(),
    twitter: typebox_1.Type.Optional(
      (0, exports.Nullable)(typebox_1.Type.String())
    ),
    discord: typebox_1.Type.Optional(
      (0, exports.Nullable)(typebox_1.Type.String())
    ),
    telegram: typebox_1.Type.Optional(
      (0, exports.Nullable)(typebox_1.Type.String())
    ),
    name: typebox_1.Type.Optional(
      (0, exports.Nullable)(typebox_1.Type.String())
    ),
    company: typebox_1.Type.Optional(
      (0, exports.Nullable)(typebox_1.Type.String())
    ),
  })
)
...
exports.PlayerImagesReponse = typebox_1.Type.Array(
  typebox_1.Type.Object({
...
exports.EggMetadata = typebox_1.Type.Object({
  ...
  attributes: typebox_1.Type.Array(
    typebox_1.Type.Object({
