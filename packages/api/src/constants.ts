...
export const MAINNET_NETWORKS = {
  1030: {
    ...
    id: 1030,
    contractAddress:
      process.env.VITE_CONFLUX_ESPACE_MAINNET_CONTRACT_ADDRESS || '0x00',
    rpcUrls: ['https://evm.confluxrpc.com'],
  },
  25: {
    name: 'Cronos Mainnet',
    id: 25,
    contractAddress: process.env.VITE_CRONOS_MAINNET_CONTRACT_ADDRESS || '0x00',
  ...
  82: {
    name: 'Meter Mainnet',
    id: 82,
    contractAddress: process.env.VITE_METER_MAINNET_CONTRACT_ADDRESS || '0x00',
    rpcUrls: ['https://rpc.meter.io'],
  },
  1088: {
    name: 'Metis Mainnet',
    id: 1088,
    contractAddress: process.env.VITE_METIS_MAINNET_CONTRACT_ADDRESS || '0x00',
...
export const TESTNET_NETWORKS = {
  ...
  338: {
    name: 'Cronos Testnet',
    id: 338,
    contractAddress: process.env.VITE_CRONOS_TESTNET_CONTRACT_ADDRESS || '0x00',
    rpcUrls: ['https://evm-t3.cronos.org'],
  },
  322: {
    name: 'KCC Testnet',
    id: 322,
    contractAddress: process.env.VITE_KCC_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  83: {
    name: 'Meter Testnet',
    id: 83,
    contractAddress: process.env.VITE_METER_TESTNET_CONTRACT_ADDRESS || '0x00',
    rpcUrls: ['https://rpctest.meter.io'],
  },
  588: {
    name: 'Metis Stardust Testnet',
    id: 588,
    contractAddress: process.env.VITE_METIS_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  80001: {
    name: 'Polygon Mumbai',
    id: 80001,
    contractAddress: process.env.VITE_POLYGON_MUMBAI_CONTRACT_ADDRESS || '0x00',
