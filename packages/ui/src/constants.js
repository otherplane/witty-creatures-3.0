...
export const NETWORKS = {
  1030: {
    ...
    kind: 'confi',
    contractAddress:
      import.meta.env.CONFLUX_ESPACE_MAINNET_CONTRACT_ADDRESS || '0x00',
  ...
  25: {
    ...
    id: 25,
    kind: 'cronian',
    contractAddress: import.meta.env.CRONOS_MAINNET_CONTRACT_ADDRESS || '0x00',
  ...
  1: {
    ...
    marketplace: import.meta.env.VITE_OPENSEA_ETHEREUM_BASE_URL,
  ...
  82: {
    ...
    id: 82,
    kind: 'meterean',
    contractAddress: import.meta.env.METER_MAINNET_CONTRACT_ADDRESS || '0x00',
  ...
  137: {
    ...
    marketplace: import.meta.env.VITE_OPENSEA_MATIC_BASE_URL,
    marketplaceName: 'OpenSea',
    confirmationCount: 3,
  },
  71: {
    ...
    kind: 'confi',
    contractAddress:
      import.meta.env.CONFLUX_ESPACE_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  338: {
    ...
    id: 338,
    kind: 'cronian',
    contractAddress: import.meta.env.CRONOS_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  322: {
    ...
    id: 322,
    kind: 'kucoiner',
    contractAddress: import.meta.env.KCC_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  4: {
    ...
    kind: 'ethereans',
    contractAddress:
      import.meta.env.ETHEREUM_RINKEBY_CONTRACT_ADDRESS || '0x00',
    rpcUrls: ['https://rpc.ankr.com/eth_rinkeby'],
    blockExplorerUrls: ['https://rinkeby.etherscan.io/'],
    marketplace: import.meta.env.VITE_OPENSEA_RINKEBY_BASE_URL,
    marketplaceName: 'OpenSea',
    confirmationCount: 3,
  },
  83: {
    ...
    id: 83,
    kind: 'meterean',
    contractAddress: import.meta.env.METER_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  588: {
    ...
    id: 588,
    kind: 'metisian',
    contractAddress: import.meta.env.METIS_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  65: {
    ...
    kind: 'okchainner',
    contractAddress:
      import.meta.env.OKXCHAIN_TESTNET_CONTRACT_ADDRESS || '0x00',
  ...
  80001: {
    ...
    marketplace: import.meta.env.VITE_OPENSEA_MUMBAI_BASE_URL,
    marketplaceName: 'OpenSea',
    confirmationCount: 3,
  },
}
